...
function targetId(req: AppRouteRequest): string {
 ...
 */
export async function GET_EXPORT(req: AppRouteRequest, res: AppRouteResponse) {
 ...
 */
export async function POST_ERASE(req: AppRouteRequest, res: AppRouteResponse) {
  const actor = authenticateRequest(req);
  requireTenantPermission(actor, { organisationId: actor.organisationId }, "user:manage");
