...
describe("dispatchMutation order.create", () => {
  ...
  it("normalises invalid source values to 'offline'", async () => {
    runWorkflowMock.mockResolvedValueOnce({
      ...
      provider: "field_order_pg", erpOrderId: null, bridgeError: null
    });
