...
export async function POST_PREVIEW(req: MedusaRouteRequest, res: MedusaRouteResponse) {
...
export async function PUT_TRANSITION(req: MedusaRouteRequest, res: MedusaRouteResponse) {
  const actor = authenticateRequest(req);
  requireTenantPermission(actor, { organisationId: actor.organisationId }, "route:plan");
