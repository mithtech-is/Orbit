...
/**
 * Dynamically load the configured maps provider. Dynamic import lets a CJS
 * runtime (medusa build) consume the ESM `@orbit/maps-provider` package
 * without bundler-level changes.
 *
 * Selection rules:
